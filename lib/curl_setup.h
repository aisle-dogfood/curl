...
/*
 * Curl_safefree_sensitive defined as a macro for freeing sensitive data.
 * This macro clears the memory content before freeing to prevent heap
 * inspection attacks, then assigns NULL to the given pointer.
 */
